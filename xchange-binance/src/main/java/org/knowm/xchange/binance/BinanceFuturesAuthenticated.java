...
public interface BinanceFuturesAuthenticated extends BinanceFutures {
  ...
  /**
   * Check an inverse order's status.<br> Either orderId or origClientOrderId must be sent.
   *
   * @param symbol
   * @param orderId           optional
   * @param origClientOrderId optional
  ...
  /**
   * Check a portfolio margin order's status.<br> Either orderId or origClientOrderId must be sent.
   *
   * @param symbol
   * @param orderId           optional
   * @param origClientOrderId optional
  ...
  /**
   * Check a portfolio margin inverse/coin margin order's status.<br> Either orderId or
  ...
  @PUT
  @Path("/fapi/v1/listenKey")
  Map<?, ?> keepAliveUserDataStream(@HeaderParam(X_MBX_APIKEY) String apiKey)
      throws IOException, BinanceException;
